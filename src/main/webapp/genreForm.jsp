...
<title><%= request.getAttribute("genre") != null ? "Editar" : "Crear" %> Género - FatMovies</title>
...
<div class="form-container">
    <div class="card">
        <div class="card-header">
            <h2 class="card-title"><%= request.getAttribute("genre") != null ? "Editar" : "Crear" %> Género</h2>
        </div>
        <div class="card-body">
