...
public class MovieRepository {
	...
	*/
	...
	public Movie findOne(int id) {
		Movie movie = null;
		String sql = "SELECT id_pelicula, id_api, name, sinopsis, duracion, adulto, titulo_original, puntuacion_api, idioma_original, poster_path, popularidad, votos_api, anioEstreno FROM peliculas WHERE id_pelicula = ?";
